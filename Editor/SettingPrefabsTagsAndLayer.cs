...
public class SettingPrefabsTagsAndLayer : EditorWindow
{
    ...
    public void OnGUI()
    {
        ...
        PrefabPaths01 = GUILayout.TextField(PrefabPaths01 , GUILayout.MinWidth(_width) , GUILayout.MaxWidth(_width * 4));   //params GUILayoutOption[] options为可选项，该选项里面有一些可额外设置的属性，比如最小和最大的宽度和高度
